                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <p>商务合作 / 广告投放：<a href="mailto:business@009tg.com">business@009tg.com</a></p>
                                    <p>问题反馈 / 建议：<a href="mailto:feedback@009tg.com">feedback@009tg.com</a></p>
                                    <p>无效链接举报：<a href="mailto:report@009tg.com">report@009tg.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>请发送邮件至 <a href="mailto:feedback@009tg.com">feedback@009tg.com</a>，邮件中请包含：网站名称、网址、网站简介、所属分类建议。我们会在审核后决定是否收录。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>请发送邮件至 <a href="mailto:report@009tg.com">report@009tg.com</a>，邮件中请包含：无效链接的网站名称、网址、具体问题（无法访问/内容不符/已改版等）。我们会尽快核实并处理。</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapse3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>我们提供多种广告合作方式，包括首页横幅广告、分类页广告、推荐位等。具体报价和方案请发送邮件至 <a href="mailto:business@009tg.com">business@009tg.com</a> 咨询。</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            'content': '''
                        ...
                        <div class="col-sm-6">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <p>Business / Advertising: <a href="mailto:business@009tg.com">business@009tg.com</a></p>
                                    <p>Feedback / Suggestions: <a href="mailto:feedback@009tg.com">feedback@009tg.com</a></p>
                                    <p>Invalid Link Reports: <a href="mailto:report@009tg.com">report@009tg.com</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>Please send an email to <a href="mailto:feedback@009tg.com">feedback@009tg.com</a> with: website name, URL, brief description, and suggested category. We will review and decide whether to include it.</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>Please send an email to <a href="mailto:report@009tg.com">report@009tg.com</a> with: the website name, URL, and specific issue (inaccessible/content mismatch/redesigned, etc.). We will verify and address it promptly.</p>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default">
                            ...
                            <div id="collapse3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <p>We offer various advertising partnership options, including homepage banner ads, category page ads, featured positions, etc. For specific pricing and plans, please email <a href="mailto:business@009tg.com">business@009tg.com</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="navbar-inner">
            <div class="navbar-brand">
                <a href="{lang_prefix}index.html" class="logo">
                    <img src="{lang_prefix}assets/images/logo_dark@2x.png" width="100%" alt="" class="hidden-xs">
            ...
            <footer class="main-footer sticky footer-type-1 fixed">
                <div class="footer-inner">
                    <div class="footer-text">
                        &copy; 2017 - 2026
                        <a href="{lang_prefix}index.html"><strong>009tg下海导航</strong></a> design by <a href="https://invisibleman.dpdns.org/" target="_blank"><strong>Invisible Man</strong></a>
                    </div>
                    <div class="go-up">
                        <a href="#" rel="go-top">
